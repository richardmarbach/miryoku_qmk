...
#include "miryoku_layer_alternatives.h"
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_HANDS_DOWN)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_HANDS_DOWN
    #elif defined (MIRYOKU_EXTRA_NERPS)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_NERPS
    #elif defined (MIRYOKU_EXTRA_WORKMAN)
